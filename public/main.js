...
module.exports = ".navbar-custom {\n  height: 100vh;\n  position: fixed;\n  left: 0;\n  top: 0;\n  width: 25%;\n  background-color: #333;\n  color: #fff;\n  top: 0; }\n  .navbar-custom .navbar-header .navbar-brand {\n    text-align: center; }\n  .navbar-custom .navbar-header .navbar-brand img {\n      width: 80%;\n      margin: 0 auto; }\n  .navbar-custom .navbar-settings {\n    padding-top: 75px;\n    padding-left: 15%;\n    padding-right: 15%;\n    height: 75px; }\n  .navbar-custom .navbar-settings .profile-picture {\n      float: left;\n      margin-top: 3px;\n      border: 2px solid transparent;\n      border-radius: 50%; }\n  .navbar-custom .navbar-settings .profile-picture img {\n        width: 65px;\n        height: 65px;\n        border-radius: 50%; }\n  .navbar-custom .navbar-settings .profile-picture.active {\n        border: 2px solid #556bff; }\n  .navbar-custom .navbar-settings .settings {\n      background-color: transparent;\n      box-shadow: none;\n      border: none;\n      float: right;\n      transition: all 1s; }\n  .navbar-custom .navbar-settings .settings fa-icon {\n        font-size: 55px;\n        color: #fff; }\n  .navbar-custom .navbar-settings .settings:hover, .navbar-custom .navbar-settings .settings:focus {\n        -webkit-transform: rotate(180deg);\n                transform: rotate(180deg);\n        transition: all 1s; }\n  .navbar-custom .navbar-settings .settings .dropdown-menu {\n        position: static;\n        float: right;\n        width: 100%;\n        background-color: #333;\n        box-shadow: 0px 0px 5px 0px #111;\n        margin-bottom: 20px; }\n  .navbar-custom .navbar-settings .settings .dropdown-menu a {\n          color: #eee;\n          padding-top: 10px;\n          padding-bottom: 10px; }\n  .navbar-custom .navbar-settings .settings .dropdown-menu a:hover, .navbar-custom .navbar-settings .settings .dropdown-menu a:focus {\n          background-color: #555; }\n  .navbar-custom .search {\n    margin-top: 20px; }\n  .navbar-custom .search .form-control {\n      background-color: #555;\n      color: #fff;\n      font-size: 18px;\n      padding-top: 25px;\n      padding-bottom: 25px;\n      box-shadow: -8px 0px 9px 0px #111; }\n  .navbar-custom .search .form-control:focus {\n        box-shadow: -8px 10px 9px 0px #111; }\n  .navbar-custom .nav-body {\n    margin-top: 30px; }\n  .navbar-custom .nav-body .nav-item {\n      width: 100%; }\n  .navbar-custom .nav-body .nav-item a {\n        padding: 10px 15%;\n        width: 100%;\n        color: #ddd;\n        font-size: 16px;\n        font-weight: bold;\n        display: block; }\n  .navbar-custom .nav-body .nav-item a:hover, .navbar-custom .nav-body .nav-item a:focus, .navbar-custom .nav-body .nav-item a.active {\n          color: #eee;\n          background-color: #222;\n          text-decoration: none; }\n  .navbar-custom .nav-body .nav-item a .unread {\n          font-size: 22px; }\n  .navbar-custom .nav-body .nav-item .unread {\n        width: 33px;\n        height: 33px;\n        background-color: #CB1616;\n        display: inline-block;\n        text-align: center;\n        vertical-align: middle;\n        padding-top: 0;\n        border-radius: 50%;\n        margin-left: 10px; }\n  .navbar-custom .collapsed-nav-content {\n    position: relative;\n    height: 93vh; }\n  .navbar-custom .footer {\n    position: absolute;\n    bottom: 20px;\n    left: 0;\n    padding: 20px;\n    font-size: 16px; }\n  .navbar-custom .footer p a, .navbar-custom .footer p a:hover, .navbar-custom .footer p a:focus {\n      color: #566BFF; }\n  .navbar-custom .footer > a, .navbar-custom .footer > a:focus, .navbar-custom .footer > a:hover {\n      color: #ddd;\n      text-decoration: underline; }\n  @media screen and (max-width: 900px) {\n  .navbar-custom {\n    width: 100%;\n    height: 55px; }\n    .navbar-custom .navbar-header button {\n      float: left; }\n      .navbar-custom .navbar-header button .icon-bar {\n        background-color: #fff; }\n    .navbar-custom .navbar-header .navbar-brand {\n      float: right;\n      width: 80%; }\n      .navbar-custom .navbar-header .navbar-brand img {\n        width: auto;\n        height: 30px;\n        float: right; }\n  .collapse-nav {\n    width: 80%;\n    height: 93vh;\n    background-color: #333;\n    padding-top: 0px;\n    position: relative;\n    left: -80%;\n    overflow: auto; }\n  .navbar-settings {\n    margin-top: 5px !important;\n    padding-top: 5px !important;\n    background-color: #333; }\n    .navbar-settings .profile-picture img {\n      width: 50px !important;\n      height: 50px !important; }\n    .navbar-settings fa-icon {\n      font-size: 42px !important; } }\n"
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.ngOnInit = function () {
        ...
        if (jquery__WEBPACK_IMPORTED_MODULE_2__(window).height() < 500) {
            jquery__WEBPACK_IMPORTED_MODULE_2__('.collapsed-nav-content').height(600);
        }
        else {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_2__(window).resize(function () {
            if (jquery__WEBPACK_IMPORTED_MODULE_2__(window).height() < 500) {
                ...
                jquery__WEBPACK_IMPORTED_MODULE_2__('#collapsed-nav-content').height(jquery__WEBPACK_IMPORTED_MODULE_2__(window).height() - 50);
            }
        });
    };
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(http, validation, auth) {
        this.http = http;
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _services_validation_service__WEBPACK_IMPORTED_MODULE_4__["ValidationService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"]])
    ], RegisterComponent);
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\honest-notes\client\src\main.ts */"./src/main.ts");
